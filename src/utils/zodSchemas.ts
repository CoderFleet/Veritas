...
export const contentTypes = ["image", "video", "article", "audio", "documentation", "repository", "projectIdea"] as const;

export const ContentValidationSchema = z.object({
    title: z.string().min(5).max(100),
    link: z.string().url(),
    tags: z.array(z.string().regex(objectIDRegex, "Invalid MongoDB Tag ID")).min(1, "At least one tag is required..."),
